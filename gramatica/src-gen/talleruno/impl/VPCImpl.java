...
public class VPCImpl extends MinimalEObjectImpl.Container implements VPC {
	...
	protected EClass eStaticClass() {
		return GramaticaPackage.Literals.VPC;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GramaticaPackage.VPC__NOMBRE, oldNombre, nombre));
	}
	...
	public EList<Recurso> getRecurso() {
		if (recurso == null) {
			recurso = new EObjectWithInverseResolvingEList<Recurso>(
					Recurso.class, this, GramaticaPackage.VPC__RECURSO,
					GramaticaPackage.RECURSO__VPC);
		}
		return recurso;
	}
	...
	public EList<GrupoSeguridad> getGruposeguridad() {
		if (gruposeguridad == null) {
			gruposeguridad = new EObjectWithInverseResolvingEList<GrupoSeguridad>(
					GrupoSeguridad.class, this,
					GramaticaPackage.VPC__GRUPOSEGURIDAD,
					GramaticaPackage.GRUPO_SEGURIDAD__VPC);
		}
	...
	public EList<Subred> getSubred() {
		if (subred == null) {
			subred = new EObjectWithInverseResolvingEList<Subred>(Subred.class,
					this, GramaticaPackage.VPC__SUBRED,
					GramaticaPackage.SUBRED__VPC);
		}
		return subred;
	}
			...
			if (internetgateway != oldInternetgateway) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GramaticaPackage.VPC__INTERNETGATEWAY,
							oldInternetgateway, internetgateway));
			}
		}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInternetgateway(
			InternetGateway newInternetgateway, NotificationChain msgs) {
		InternetGateway oldInternetgateway = internetgateway;
		internetgateway = newInternetgateway;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, GramaticaPackage.VPC__INTERNETGATEWAY,
					oldInternetgateway, newInternetgateway);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setInternetgateway(InternetGateway newInternetgateway) {
		if (newInternetgateway != internetgateway) {
			...
			if (internetgateway != null)
				msgs = ((InternalEObject) internetgateway).eInverseRemove(this,
						GramaticaPackage.INTERNET_GATEWAY__VPC,
						InternetGateway.class, msgs);
			if (newInternetgateway != null)
				msgs = ((InternalEObject) newInternetgateway).eInverseAdd(this,
						GramaticaPackage.INTERNET_GATEWAY__VPC,
						InternetGateway.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					GramaticaPackage.VPC__INTERNETGATEWAY, newInternetgateway,
					newInternetgateway));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		switch (featureID) {
		case GramaticaPackage.VPC__RECURSO:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getRecurso())
					.basicAdd(otherEnd, msgs);
		case GramaticaPackage.VPC__GRUPOSEGURIDAD:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getGruposeguridad())
					.basicAdd(otherEnd, msgs);
		case GramaticaPackage.VPC__SUBRED:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getSubred())
					.basicAdd(otherEnd, msgs);
		case GramaticaPackage.VPC__INTERNETGATEWAY:
			if (internetgateway != null)
				msgs = ((InternalEObject) internetgateway).eInverseRemove(this,
						GramaticaPackage.INTERNET_GATEWAY__VPC,
						InternetGateway.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case GramaticaPackage.VPC__RECURSO:
			return ((InternalEList<?>) getRecurso())
					.basicRemove(otherEnd, msgs);
		case GramaticaPackage.VPC__GRUPOSEGURIDAD:
			return ((InternalEList<?>) getGruposeguridad()).basicRemove(
					otherEnd, msgs);
		case GramaticaPackage.VPC__SUBRED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GramaticaPackage.VPC__NOMBRE:
			return getNombre();
		case GramaticaPackage.VPC__RECURSO:
			return getRecurso();
		case GramaticaPackage.VPC__GRUPOSEGURIDAD:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case GramaticaPackage.VPC__GRUPOSEGURIDAD:
			...
			getGruposeguridad().addAll(
					(Collection<? extends GrupoSeguridad>) newValue);
			return;
		case GramaticaPackage.VPC__SUBRED:
			getSubred().clear();
