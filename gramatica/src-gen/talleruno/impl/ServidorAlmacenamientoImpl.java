 ...
 * @generated
 */
public class ServidorAlmacenamientoImpl extends RecursoImpl implements
	...
	protected EClass eStaticClass() {
		return GramaticaPackage.Literals.SERVIDOR_ALMACENAMIENTO;
	}
	...
	public void setTamanioInicial(int newTamanioInicial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GramaticaPackage.SERVIDOR_ALMACENAMIENTO__TAMANIO_INICIAL,
					oldTamanioInicial, tamanioInicial));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GramaticaPackage.SERVIDOR_ALMACENAMIENTO__TAMANIO_INICIAL:
