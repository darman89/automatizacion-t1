 ...
 * <!-- end-user-doc -->
 * @see talleruno.TallerunoPackage#getManejadorSQL()
 * @model
 * @generated
 */
public enum ManejadorSQL implements Enumerator {
	 ...
	 * @generated
	 */
	private static final ManejadorSQL[] VALUES_ARRAY =
		new ManejadorSQL[] {
			POSTGRESQL,
			MYSQL,
			ORACLE,
	 ...
	 * @generated
	 */
	public static final List<ManejadorSQL> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
