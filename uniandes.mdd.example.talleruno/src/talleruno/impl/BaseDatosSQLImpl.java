 ...
 * @generated
 */
public class BaseDatosSQLImpl extends ServidorBaseDatosImpl implements BaseDatosSQL {
	/**
	...
	protected EClass eStaticClass() {
		return TallerunoPackage.Literals.BASE_DATOS_SQL;
	}
	...
	public void setManejador(ManejadorSQL newManejador) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TallerunoPackage.BASE_DATOS_SQL__MANEJADOR, oldManejador, manejador));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TallerunoPackage.BASE_DATOS_SQL__MANEJADOR:
				return getManejador();
		}
