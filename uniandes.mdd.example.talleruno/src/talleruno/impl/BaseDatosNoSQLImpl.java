 ...
 * @generated
 */
public class BaseDatosNoSQLImpl extends ServidorBaseDatosImpl implements BaseDatosNoSQL {
	/**
	...
	protected EClass eStaticClass() {
		return TallerunoPackage.Literals.BASE_DATOS_NO_SQL;
	}
	...
	public void setManejador(ManejadorNoSQL newManejador) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TallerunoPackage.BASE_DATOS_NO_SQL__MANEJADOR, oldManejador, manejador));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TallerunoPackage.BASE_DATOS_NO_SQL__MANEJADOR:
				return getManejador();
		}
