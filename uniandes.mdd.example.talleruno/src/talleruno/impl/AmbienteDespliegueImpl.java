...
public class AmbienteDespliegueImpl extends MinimalEObjectImpl.Container implements AmbienteDespliegue {
	...
	protected EClass eStaticClass() {
		return TallerunoPackage.Literals.AMBIENTE_DESPLIEGUE;
	}
	...
	public void setNombre(NombreAmbiente newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TallerunoPackage.AMBIENTE_DESPLIEGUE__NOMBRE, oldNombre, nombre));
	}
	...
	public EList<Recurso> getRecursos() {
		if (recursos == null) {
			recursos = new EObjectContainmentEList<Recurso>(Recurso.class, this, TallerunoPackage.AMBIENTE_DESPLIEGUE__RECURSOS);
		}
		return recursos;
	}
	...
	public EList<Conexión> getConexiones() {
		if (conexiones == null) {
			conexiones = new EObjectContainmentEList<Conexión>(Conexión.class, this, TallerunoPackage.AMBIENTE_DESPLIEGUE__CONEXIONES);
		}
		return conexiones;
	}
	...
	public EList<MecanismoSeguridad> getSeguridad() {
		if (seguridad == null) {
			seguridad = new EObjectContainmentEList<MecanismoSeguridad>(MecanismoSeguridad.class, this, TallerunoPackage.AMBIENTE_DESPLIEGUE__SEGURIDAD);
		}
		return seguridad;
	}
	...
	public EList<VPC> getVpc() {
		if (vpc == null) {
			vpc = new EObjectContainmentEList<VPC>(VPC.class, this, TallerunoPackage.AMBIENTE_DESPLIEGUE__VPC);
		}
		return vpc;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TallerunoPackage.AMBIENTE_DESPLIEGUE__RECURSOS:
				return ((InternalEList<?>)getRecursos()).basicRemove(otherEnd, msgs);
			case TallerunoPackage.AMBIENTE_DESPLIEGUE__CONEXIONES:
				return ((InternalEList<?>)getConexiones()).basicRemove(otherEnd, msgs);
			case TallerunoPackage.AMBIENTE_DESPLIEGUE__SEGURIDAD:
				return ((InternalEList<?>)getSeguridad()).basicRemove(otherEnd, msgs);
			case TallerunoPackage.AMBIENTE_DESPLIEGUE__VPC:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TallerunoPackage.AMBIENTE_DESPLIEGUE__NOMBRE:
				return getNombre();
			case TallerunoPackage.AMBIENTE_DESPLIEGUE__RECURSOS:
				return getRecursos();
			case TallerunoPackage.AMBIENTE_DESPLIEGUE__CONEXIONES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case TallerunoPackage.AMBIENTE_DESPLIEGUE__SEGURIDAD:
				getSeguridad().clear();
				getSeguridad().addAll((Collection<? extends MecanismoSeguridad>)newValue);
				return;
			case TallerunoPackage.AMBIENTE_DESPLIEGUE__VPC:
				getVpc().clear();
