...
public abstract class MecanismoSeguridadImpl extends MinimalEObjectImpl.Container implements MecanismoSeguridad {
	...
	protected EClass eStaticClass() {
		return TallerunoPackage.Literals.MECANISMO_SEGURIDAD;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TallerunoPackage.MECANISMO_SEGURIDAD__NOMBRE, oldNombre, nombre));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TallerunoPackage.MECANISMO_SEGURIDAD__NOMBRE:
				return getNombre();
		}
